    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#EB5D4D", textColor: "#FFFFFF", text: "1" },
    ...
    destinations: [
      {
        ...
        name: "COLLIGNON",
        girouette: {
          routeNumber: { backgroundColor: "#E50063", textColor: "#FFFFFF", text: "2" },
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#9E5049", textColor: "#FFFFFF", text: "3" },
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#F39200", textColor: "#FFFFFF", text: "4" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "LA GLACERIE MARETTES" }],
        },
      },
      {
        id: ["SCHUMAN"],
    ...
    destinations: [
      {
        ...
        name: "SAUXMARAIS",
        girouette: {
          routeNumber: { backgroundColor: "#F5A681", textColor: "#FFFFFF", text: "6" },
    ...
    destinations: [
      {
        ...
        name: "SCHUMAN-DELAVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#F195BF", textColor: "#FFFFFF", text: "7" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "SCHUMAN-DELAVILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#58529E", textColor: "#FFFFFF", text: "A" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "SCHUMAN-DELAVILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        name: "CHERBOURG EN COTENTIN SCHUMAN-DELAVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#1EB8D1", textColor: "#FFFFFF", text: "B" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "SCHUMAN-DELAVILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        name: "CHERBOURG EN COTENTIN SCHUMAN-DELAVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#86B5E2", textColor: "#FFFFFF", text: "C" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "SCHUMAN-DELAVILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        name: "CHERBOURG EN COTENTIN SCHUMAN-DELAVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#107974", textColor: "#FFFFFF", text: "D" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "SCHUMAN-DELAVILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        name: "CHERBOURG EN COTENTIN SCHUMAN-DELAVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#47B7A2", textColor: "#FFFFFF", text: "E" },
          pages: [{ font: "1508C2E1", textSpacing: 3, text: "SCHUMAN-DELAVILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#9774B1", textColor: "#FFFFFF", text: "F" },
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "N1" },
          pages: [{ text: "EGLANTINE CHATEAU-LA GLACERIE" }],
        },
      },
      {
        id: ["HOTEL DE VILLE"],
    ...
    destinations: [
      {
        ...
        name: "HOTEL DE VILLE",
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "N2" },
          pages: [{ text: "HOTEL DE VILLE" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ font: "1508C2E1", text: "CHERBOURG-EN-COTENTIN" }, { text: "LYCEE DOUCET" }],
        },
      },
      {
        id: ["GROSVILLE MAIRIE"],
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ font: "1508C2E1", text: "CHERBOURG-EN-COTENTIN" }, { text: "SCHUMAN" }],
        },
      },
      {
        id: ["PORTBAIL RUE LECHEVALIER"],
  ...
  },
  {
    ...
    destinations: [
      ...
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S3" },
          pages: [{ text: "EMONDEVILLE LE COUP DE FREIN" }],
        },
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S3" },
          pages: [{ text: "QUINEVILLE LA POSTE" }],
        },
      },
    ],
  },
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ text: "CHERBOURG EN COTENTIN COLLEGE DIDEROT" }],
        },
      },
      {
        id: ["CRASVILLE LE BAS"],
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ text: "CHERBOURG EN COTENTIN IUT" }],
        },
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S5" },
          pages: [{ text: "MONTFARVILLE MAIRIE" }],
        },
      },
      {
        id: ["REVILLE EGLISE"],
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ text: "CHERBOURG EN COTENTIN QUAI COLLINS" }],
        },
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S6" },
          pages: [{ text: "GATTEVILLE LE PHARE RTE DU VAL DE SAIRE" }],
        },
      },
    ],
  },
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ text: "SAINT PIERRE EGLISE ECOLE ELEMENTAIRE" }],
        },
      },
      {
        id: ["CLITOURPS EGLISE"],
      ...
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S7" },
          pages: [{ text: "SAINT PIERRE EGLISE COLLEGE" }],
        },
      },
    ],
  },
  {
    ...
    destinations: [
      ...
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S8" },
          pages: [{ text: "LE THEIL LES ECOLES" }],
        },
      },
      {
        id: ["SAINT PIERRE EGLISE COLLEGE"],
  ...
  },
  {
    ...
    destinations: [
      ...
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "S9" },
          pages: [{ text: "FIERVILLE LES MINES LA PLACE" }],
        },
      },
    ],
  },
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "SCO1" },
          pages: [{ text: "TOCQUEVILLE/SAUXMARAIS" }],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        name: "MILLET/IUT",
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "SCO2" },
      ...
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "SCO2" },
          pages: [{ text: "QUERQUEVILLE MAIRIE PAR LA MARCHE" }],
        },
      },
      {
        id: ["A. THOMAS"],
    ...
    destinations: [
      {
        ...
        name: "HAMEAU PHARES",
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "SCO3" },
          pages: [{ text: "HAMEAU PHARES" }],
        },
      },
    ],
  },
    ...
    destinations: [
      {
        ...
        name: "COLLEGE FERRY",
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "SCO4" },
          pages: [{ text: "COLLEGE FERRY" }],
        },
      },
      {
        id: ["TERRASSES"],
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFFFFF", textColor: "#000000", text: "SCO6" },
          pages: [{ text: "COLLEGE DIDEROT" }],
        },
      },
      {
