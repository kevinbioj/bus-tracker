...
const astuceRoutes: Route[] = [
    ...
    destinations: [
      {
        ...
        city: "GRAND-QUEVILLY",
        girouette: {
          routeNumber: { backgroundColor: "#F5C500", textColor: "#000000", outlineColor: "#FFFFFF", text: "T4" },
          pages: [
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["Centre Commercial TOURVILLE-LA-RIVIÈRE"],
      ...
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#FFDD00", textColor: "#000000", text: "F3" },
          pages: [
            { font: "1510N2E1", text: "POLE MULTIMODAL" },
            { spacing: 4, text: "OISSEL" },
          ],
        },
      },
      {
    ...
    destinations: [
      ...
      },
      {
        ...
        girouette: {
          ...
          pages: [
            { font: "1510N2E1-TCAR", spacing: 1, text: "HAMEAU DE FREVAUX" },
            { spacing: 4, text: "MALAUNAY" },
          ],
        },
      },
    ],
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["Les Bouttières GRAND-COURONNE"],
        name: "Les Bouttières",
        city: "GRAND-COURONNE",
        girouette: {
          routeNumber: {
    ...
    destinations: [
      {
        ...
        city: "ROUEN",
        girouette: {
          routeNumber: { backgroundColor: "#F8AE4C", textColor: "#000000", outlineColor: "#FFFFFF", text: "10" },
  ...
  },
  {
    ...
    destinations: [
      ...
      {
        id: ["École de Musique BOOS", "École de Musique"],
        name: "École de Musique",
        city: "BOOS",
        girouette: {
          routeNumber: { backgroundColor: "#F8AE4C", textColor: "#000000", outlineColor: "#FFFFFF", text: "13" },
          pages: [
            { font: "1510N2E1", text: "ECOLE DE MUSIQUE" },
            { spacing: 4, text: "BOOS" },
          ],
        },
      },
    ...
    destinations: [
      ...
      },
      {
        ...
        girouette: {
          ...
          pages: [
            { spacing: 4, text: "MAIRIE" },
            { spacing: 4, text: "BELBEUF" },
          ],
        },
      },
    ],
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [
            { spacing: 4, text: "GRAND VAL" },
            { font: "1508C2E1", text: "AMFREVILLE-LA-MIVOIE" },
          ],
        },
      },
      {
      ...
      {
        id: ["Collège Jules Verne DÉVILLE-LÈS-ROUEN"],
        name: "Jules Verne",
        city: "DÉVILLE-LÈS-ROUEN",
        girouette: {
          routeNumber: { backgroundColor: "#74B95B", textColor: "#000000", outlineColor: "#FFFFFF", text: "15" },
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [
            { spacing: 4, text: "MAIRIE" },
            { font: "1508C2E1", spacing: 3, text: "SAINT-AUBIN-EPINAY" },
          ],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        city: "ROUEN",
        girouette: {
          routeNumber: { backgroundColor: "#F4A3AF", textColor: "#000000", outlineColor: "#FFFFFF", text: "22" },
          pages: [
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [{ text: "MONT-RIBOUDET" }, { spacing: 5, text: "ROUEN" }],
        },
      },
      {
        id: ["Salle des Fêtes"],
        ...
        girouette: {
          ...
          pages: [
            ...
            [
              { spacing: 3, text: "SAINT-PIERRE" },
              { spacing: 3, text: "DE-VARENGEVILLE" },
            ],
          ],
        },
      },
    ...
    destinations: [
      {
        ...
        girouette: {
          ...
          pages: [
            { spacing: 4, text: "BEL AIR" },
            { font: "1510N2E1", text: "PETIT-COURONNE" },
          ],
        },
      },
      {
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#F4A3AF", textColor: "#000000", outlineColor: "#FFFFFF", text: "28" },
          pages: [
            { spacing: 4, text: "BOIS TISON" },
            [
              { spacing: 3, text: "SAINT-JACQUES" },
              { spacing: 3, text: "SUR-DARNETAL" },
            ],
          ],
        },
      },
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["François Truffaut PETIT-QUEVILLY", "François Truffaut"],
    ...
    destinations: [
      {
        ...
        city: "CANTELEU",
        girouette: {
          routeNumber: { backgroundColor: "#D3D800", textColor: "#000000", outlineColor: "#FFFFFF", text: "35" },
          pages: [
            { font: "1510N2E1-TCAR", spacing: 1, text: "SENTE D'HOUDEVILLE" },
            { spacing: 4, text: "CANTELEU" },
          ],
        },
      },
      {
        id: ["Mont-Riboudet ROUEN", "Mont-Riboudet Kindarena"],
        autoHide: true,
        name: "Mont-Riboudet - Kindarena",
        city: "ROUEN",
        girouette: {
      ...
      {
        id: ["École Moulin NOTRE-DAME-DE-BONDEVILLE", "École Moulin"],
        name: "École Moulin",
        city: "NOTRE-DAME-DE-BONDEVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#D3D800", textColor: "#000000", outlineColor: "#FFFFFF", text: "35" },
    ...
    destinations: [
      {
        ...
        city: "ROUEN",
        girouette: {
          routeNumber: { backgroundColor: "#D3D800", textColor: "#000000", outlineColor: "#FFFFFF", text: "36" },
    ...
    destinations: [
      {
        ...
        city: "ISNEAUVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#D3D800", textColor: "#000000", outlineColor: "#FFFFFF", text: "37" },
          pages: [
            { font: "1510N2E1-TCAR", spacing: 1, text: "PLAINE DE LA RONCE" },
    ...
    destinations: [
      {
        ...
        city: "MONTMAIN",
        girouette: {
          routeNumber: { backgroundColor: "#D3D800", textColor: "#000000", outlineColor: "#FFFFFF", text: "38" },
          pages: [
            { spacing: 4, text: "MAIRIE" },
            { spacing: 4, text: "MONTMAIN" },
          ],
        },
      },
      {
        ...
        girouette: {
          routeNumber: { backgroundColor: "#D3D800", textColor: "#000000", outlineColor: "#FFFFFF", text: "38" },
          pages: [
            { font: "1510N2E1", text: "COTEAUX BRANLY" },
            { spacing: 4, text: "DARNETAL" },
          ],
        },
      },
    ...
    destinations: [
      {
        ...
        city: "SAINT-ÉTIENNE-DU-ROUVRAY",
        girouette: {
          routeNumber: { backgroundColor: "#F8AE4C", textColor: "#000000", outlineColor: "#FFFFFF", text: "41" },
      ...
      {
        id: ["Ancienne Mare PETIT-QUEVILLY"],
        name: "Ancienne Mare",
        city: "PETIT-QUEVILLY",
        girouette: {
          routeNumber: { backgroundColor: "#F8AE4C", textColor: "#000000", outlineColor: "#FFFFFF", text: "41" },
    ...
    destinations: [
      {
        ...
        girouette: {
          routeNumber: {
            backgroundColor: "#9BD4E3",
            textColor: "#000000",
            outlineColor: "#FFFFFF",
            text: "43",
          },
          pages: [
            { font: "1510N2E1", text: "PLACE DU VIVIER" },
            { spacing: 3, text: "HOUPPEVILLE" },
          ],
        },
      },
      {
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["E. Lacroix SAINT-PIERRE-DE-MANNEVILLE", "E. Lacroix"],
        name: "Édouard Lacroix",
        city: "SAINT-PIERRE-DE-MANNEVILLE",
        girouette: {
          routeNumber: { backgroundColor: "#9BD4E3", textColor: "#000000", outlineColor: "#FFFFFF", text: "44" },
          pages: [
            { font: "1510N2E1", text: "EDOUARD LACROIX" },
            [
              { spacing: 3, text: "SAINT-PIERRE" },
              { spacing: 3, text: "DE-MANNEVILLE" },
            ],
          ],
        },
      },
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["TOURVILLE - CENTRE COMMERCIAL"],
        name: "Centre Commercial",
        city: "TOURVILLE-LA-RIVIÈRE",
        girouette: {
          routeNumber: {
            backgroundColor: "#38B4B6",
            textColor: "#FFFFFF",
            outlineColor: "#000000",
            font: "1508SUPX",
            text: "I",
          },
          pages: [{ font: "1508SUPX", text: "CENTRE COMMERCIAL" }],
        },
      },
      {
        id: ["ECOLE DE POLICE"],
        ...
        girouette: {
          ...
          pages: [{ font: "1508SUPX", text: "ECOLE DE POLICE" }],
        },
      },
    ],
  },
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["École Cousteau STE-MARGUERITE-SUR-DUCLAIR (matin)", "École Cousteau STE-MARGUERITE-SUR-DUCLAIR (soir)"],
        autoHide: true,
        name: "École Cousteau",
        city: "SAINTE-MARGUERITE-SUR-DUCLAIR",
        girouette: {
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["École ÉPINAY-SUR-DUCLAIR (matin)", "École ÉPINAY-SUR-DUCLAIR (soir)"],
        autoHide: true,
  ...
  },
  {
    ...
    destinations: [
      ...
      {
        id: ["Route de Yainville JUMIÈGES"],
        autoHide: true,
        name: "Route de Yainville",
        city: "JUMIÈGES",
        girouette: {
          routeNumber: {
            backgroundColor: "#E83278",
          ...
          pages: [
            { font: "1508SUPX", text: "ROUTE DE YAINVILLE" },
            { font: "1508SUPX", text: "JUMIEGES" },
          ],
        },
      },
  ...
  },
  {
    ...
    destinations: [
      {
        id: ["Mairie - École d'Yville YVILLE-SUR-SEINE (matin)", "Mairie - École d'Yville YVILLE-SUR-SEINE (soir)"],
        autoHide: true,
  ...
  },
  {
    ...
    destinations: [
      ...
      {
        id: ["Chemin des Monts DUCLAIR"],
        autoHide: true,
        name: "Chemin des Monts",
        city: "DUCLAIR",
        girouette: {
          routeNumber: {
            backgroundColor: "#007D62",
          ...
          pages: [
            { font: "1508SUPX", text: "CHEMIN DES MONTS" },
            { font: "1508SUPX", text: "DUCLAIR" },
          ],
        },
      },
  ...
  },
  {
    ...
    destinations: [
      ...
      {
        id: ["Stade Maurice Chatel DUCLAIR"],
        autoHide: true,
        name: "Stade Maurice Chatel",
        city: "DUCLAIR",
        girouette: {
          routeNumber: {
            backgroundColor: "#F2E500",
          ...
          pages: [
            { font: "1407SUPX", text: "STADE MAURICE CHATEL" },
            { font: "1508SUPX", text: "DUCLAIR" },
          ],
        },
      },
  ...
  },
  {
    ...
    destinations: [
      ...
      {
        id: ["Ponton Ile Lacroix"],
        name: "Ponton Ile Lacroix",
        city: "ROUEN",
        girouette: {
          ledColor: "WHITE",
          routeNumber: {
          ...
          pages: [
            [
              { spacing: 2, text: "PONTON" },
              { spacing: 2, text: "ILE LACROIX" },
            ],
          ],
        },
      },
